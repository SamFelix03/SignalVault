...
export const VAULT_FACTORY_ADDRESS = (process.env.VAULT_FACTORY_ADDRESS || '0x533FE38d998B2B289cD7Fb0A4a968CD55173BaB9') as Address;
...
export const DEMO_VAULT_ADDRESS = (process.env.DEMO_VAULT_ADDRESS || '0xf8D8682c8D7cD30aD5f7D2579060d14943E80126') as Address;
export const DEMO_ORCHESTRATOR_ADDRESS = (process.env.DEMO_ORCHESTRATOR_ADDRESS || '0x3BC2afC969899ef8377a61D4e64E4180B0bf5Ac5') as Address;
export const DEMO_MIRROR_REACTOR = (process.env.DEMO_MIRROR_REACTOR || '0x434108F91F619e9C2022A312eAf16EddB5A334a4') as Address;
export const DEMO_PERFORMANCE_LEDGER = (process.env.DEMO_PERFORMANCE_LEDGER || '0xF1B258C8Cf375B0639Ead833AfE63f36cc650798') as Address;
