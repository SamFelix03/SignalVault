...
export const VAULT_FACTORY_ADDRESS = (process.env.VAULT_FACTORY_ADDRESS || '0xEC4c2EbDC3ead82C842c8932d7956Dca49e68C0E') as Address;
...
export const PERFORMANCE_LEDGER_ADDRESS = (process.env.PERFORMANCE_LEDGER_ADDRESS || '0x1d0c6CDbaFEeeFC6D736f2e6F2D20d287f27456E') as Address;

// ── Agent IDs ───────────────────────────────────────────────────────
export const JSON_API_AGENT_ID = 13174292974160097713n;
export const LLM_PARSE_AGENT_ID = 13174292974160097713n;
export const LLM_INFER_AGENT_ID = 13174292974160097713n;
