...
export function FeaturedVaultCard({ vault }: FeaturedVaultCardProps) {
  ...
  return (
    <Link href={`/vault/${vault.address}`} className="group block">
      <div className="rounded-xl border border-border bg-card p-6 transition-colors hover:border-muted-foreground/25 md:p-8">
